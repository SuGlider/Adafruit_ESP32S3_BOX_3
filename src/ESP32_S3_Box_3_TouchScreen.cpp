...
boolean ESP32S3BOX3_TS::begin() {
  // avoids Serial Monitor / Any Soft Reset to fail I2C initialization.
  Wire1.end(); 
  // initializes I2C to read Touch Screen 
...
uint16_t ESP32S3BOX3_TS::readMessageLen(void) {
...
uint8_t ESP32S3BOX3_TS::touched(void) {
  // reset all information
  touchX[0] = touchY[0] = touchPressure[0] = 0;
  touchX[1] = touchY[1] = touchPressure[1] = 0;
  touches = 0;
...
TS_Point ESP32S3BOX3_TS::getPoint(uint8_t n) {
