...
#define ESP32S3BOX3_TFTWIDTH  320
#define ESP32S3BOX3_TFTHEIGHT 240
#define BOX3_SPI_DEFAULT_FREQ 80000000
...
/// Subclass of SPITFT for ILI9341 displays (lots in common!)
class ESP32S3BOX3_TFT : public Adafruit_SPITFT {
public:
  ESP32S3BOX3_TFT();
