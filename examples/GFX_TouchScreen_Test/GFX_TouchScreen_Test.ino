/***************************************************
  This is based on GFX example for the Adafruit ILI9341 Breakout and Shield
...
ESP32S3BOX3_TFT tft = ESP32S3BOX3_TFT();
ESP32S3BOX3_TS  ts = ESP32S3BOX3_TS();
...
void setup() {
  ...
  Serial.println("\nNow it will show a rotating Text and print the touch coordinates in Serial output.");
